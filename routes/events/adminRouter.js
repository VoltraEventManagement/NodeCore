...
const {createEvent , updateEvent, deleteEvent , downloadMonthlyReportExcel, adminUpdateUser } = require("../../controllers/eventsControllers/adminController")
...
adminRouter.patch("/updateUser/:id", authorizedAdmin("admin"),adminUpdateUser)
